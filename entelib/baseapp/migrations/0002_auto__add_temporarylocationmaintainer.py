...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TemporaryLocationMaintainer'
        db.create_table('baseapp_temporarylocationmaintainer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['baseapp.Location'])),
        ))
        db.send_create_signal('baseapp', ['TemporaryLocationMaintainer'])

        # Adding M2M table for field maintainer on 'TemporaryLocationMaintainer'
        db.create_table('baseapp_temporarylocationmaintainer_maintainer', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('temporarylocationmaintainer', models.ForeignKey(orm['baseapp.temporarylocationmaintainer'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('baseapp_temporarylocationmaintainer_maintainer', ['temporarylocationmaintainer_id', 'user_id'])


    def backwards(self, orm):
        
        # Deleting model 'TemporaryLocationMaintainer'
        db.delete_table('baseapp_temporarylocationmaintainer')

        # Removing M2M table for field maintainer on 'TemporaryLocationMaintainer'
        db.delete_table('baseapp_temporarylocationmaintainer_maintainer')
