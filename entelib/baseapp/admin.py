...
from entelib.baseapp.models import EmailLog, Building, Location, Configuration, UserConfiguration, State, Publisher, Author, Book, BookCopy, BookRequest, Reservation, Rental, Phone, PhoneType, CostCenter, Category, UserProfile
...
for model in [EmailLog, Building, Location, Configuration, UserConfiguration, State, Publisher, Author, Book, BookCopy, BookRequest, Reservation, Rental, Phone, PhoneType, CostCenter, Category, UserProfile]:
