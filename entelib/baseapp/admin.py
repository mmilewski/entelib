...
from entelib.baseapp.models import Building, Location, Configuration, State, Publisher, Picture, Author, Book, BookCopy, BookRequest, Reservation, Rental, Phone, PhoneType, CostCenter, Category, UserProfile
...
for model in [Building, Location, Configuration, State, Publisher, Picture, Author, Book, BookCopy, BookRequest, Reservation, Rental, Phone, PhoneType, CostCenter, Category, UserProfile]:
